...
sed 's/ACCESS_KEY/'$ACCESS_KEY'/g' terraform-example.tfvars > terraform.tfvars
sed 's/SECRET_KEY/'$SECRET_KEY'/g' terraform-example.tfvars > terraform.tfvars
sed 's/NODE_COUNT/'$NODE_COUNT'/g' terraform-example.tfvars > terraform.tfvars
